...
declare type Props = {
    ...
    onSearchParameters?: (getSearchParameters: ConnectorDescription['getSearchParameters'], context: {
        ais: InstantSearchContext;
        multiIndexContext: IndexContext;
    }, props: object, searchState: SearchState) => void;
...
declare class InstantSearch extends Component<Props, State> {
    ...
    static propTypes: {
        ...
        searchClient: PropTypes.Validator<PropTypes.InferProps<{
    ...
    onSearchParameters(getSearchParameters: ConnectorDescription['getMetadata'], context: {
        ais: InstantSearchContext;
        multiIndexContext: IndexContext;
    }, props: object, getMetadata: ConnectorDescription['getMetadata']): void;
