...
export declare function addAbsolutePositions(hits: any, hitsPerPage: any, page: any): any;
export declare function addQueryID(hits: any, queryID: any): any;
export declare function find<TItem = any>(array: TItem[], comparator: (item: TItem) => boolean): TItem | undefined;
export declare function objectHasKeys(object: object | undefined): boolean;
export declare function omit(source: {
    [key: string]: any;
}, excluded: string[]): {};
/**
 ...
 */
export declare const getPropertyByPath: (object: object, path: string | string[]) => any;
