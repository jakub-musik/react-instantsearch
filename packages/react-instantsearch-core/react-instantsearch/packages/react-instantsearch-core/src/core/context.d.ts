...
export declare const instantSearchContext: import("react").Context<InstantSearchContext>;
export declare const InstantSearchConsumer: import("react").Consumer<InstantSearchContext>, InstantSearchProvider: import("react").Provider<InstantSearchContext>;
export declare type IndexContext = {
    targetedIndex: string;
} | undefined;
export declare const IndexConsumer: import("react").Consumer<{
    targetedIndex: string;
}>, IndexProvider: import("react").Provider<{
    targetedIndex: string;
}>;
